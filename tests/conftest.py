...
def isolated_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(config, "wiki_reference_expansion_enabled", False)
    monkeypatch.setattr(config, "wiki_reference_limit", 100)
    monkeypatch.setattr(config, "wiki_reference_download_limit", 100)
    monkeypatch.setattr(config, "wiki_reference_timeout_seconds", 1.0)
    monkeypatch.setattr(config, "wiki_idea_query_paper_limit", 100)
    monkeypatch.setattr(config, "wiki_idea_query_character_limit", 36000)
